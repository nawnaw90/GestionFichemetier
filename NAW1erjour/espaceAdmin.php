...
<?php if ($_SESSION['user']->role == "super"): ?>
 ...
 <!-- add admin form -->
 <h1>Bonjour Super Admin  Add admin</h1>
...
<?php endif; ?>
                ...
                <div class="text-center">
                        <h1 class="p-5">Bonjour ! <?php echo $_SESSION['user']->mail; ?><i class="far fa-meh-rolling-eyes"></i><i class="far fa-grin-beam"></i></h1>
                        <hr />
                        <!-- Button trigger modal -->
                        
                        <a href="change_password.php" class="btn btn-danger btn-lg" >Changer mot de passe</a>
